...
class OSCRUI():
    ...
    def setup_left_sidebar_log(self):
        ...
        entry_button_config = {
            ...
            self._('Analyze'): {'callback': lambda: self.analyze_log_callback(self.translate, path=self.entry.text()), 'align': ARIGHT}
        }
        ...
        self.current_combats.doubleClicked.connect(
            lambda: self.analyze_log_callback(self.translate, self.current_combats.currentRow()))
